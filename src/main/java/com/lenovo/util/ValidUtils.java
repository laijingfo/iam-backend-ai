...
//    private static final String username="^[\\u4E00-\\u9FA5\\uF900-\\uFA2D\\w]$";
    private static final String username="^[a-zA-Z0-9_\\u4e00-\\u9fa5]+$";
    /** 字母*/
    ...
    /**判断密码合法性*/
    private static final String password="^[a-zA-Z0-9]{8,18}$";
    ...
    public static boolean isPassword(String outputPassword){
        return matches(password, outputPassword);
    }
