...
/**
 * @Description TODO 直属经理自动邮件发送临时表实体类
 * @ClassName AutoMailSendLineManagerTemp
 * @Author wangfenglong
 * @Date 2025/12/26 12:03
 **/
@Data
@TableName("auto_mail_send_lineManager_temp")
public class AutoMailSendLineManagerTemp
{
    /**
     * 主键自增
     */
